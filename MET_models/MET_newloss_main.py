...
DATASET_CFG = {
    ...
    # pt-penalized loss: MSE + lambda_pt * 1{GenMET_pt > genmet_threshold} * (MET_pt_pred/GenMET_pt - 1)^2
    "lambda_pt":             1.0,
...
def _parse_args():
    parser = argparse.ArgumentParser(
        description="Train MET_newloss model.",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Overrides the default '../Results/results_newloss'. "
            "If not given but --transform is set, defaults to "
            "'../Results/results_newloss_<transform>'."
        ),
    )
...
if __name__ == "__main__":
    ...
    if args.output_dir is not None:
        ...
        OUTPUT_DIR = f"../Results/results_newloss_{transform}_2d"
    else:
        OUTPUT_DIR = "../Results/results_newloss_2d"
    ...
    (X_train, y_train,
     ...
     topk_buffer) = _model_selection(
        features, target, MET_pt, HPARAM_GRID, OUTPUT_DIR, DATASET_CFG
    )
